...
const MainSubview = (props: MainSubviewProps) => {
    var overviewSpan = <FloatingSpan className="trailer-layout-mid" id="trailer-subview-main-span-0" key={0}>
        <img id="trailer-subview-main-span-0-logo" src="resources/TrailerPage/TrailerSubviews/MainSubview/img-0.png" alt="Daorffo D1 Expedition Trailer Logo" />
        ...
        <img id="trailer-subview-main-span-0-trailerimg" alt="Daorffo D1 off-road trailer expedition setup" src="resources/TrailerPage/TrailerSubviews/MainSubview/img-1.png" />
    </FloatingSpan>
